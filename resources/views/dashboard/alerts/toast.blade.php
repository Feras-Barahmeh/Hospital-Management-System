...
@push('css')
    <!---Internal  Prism css-->
    <link href="{{ asset('dashboard/plugins/prism/prism.css')}}" rel="stylesheet">
    <!---Internal Input tags css-->
    <link href="{{ asset('dashboard/plugins/inputtags/inputtags.css')}}" rel="stylesheet">
    <!--- Custom-scroll -->
    <link href="{{ asset('dashboard/plugins/custom-scroll/jquery.mCustomScrollbar.css')}}" rel="stylesheet">
@endpush
@section('page-header')
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active mr-1 html-code" id="html-code" data-toggle="tab" href="#html-code" role="tab" aria-controls="html-code" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active mr-1 html-code" id="html-code2" data-toggle="tab" href="#html-code2" role="tab" aria-controls="html-code2" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active mr-1 html-code" id="html-code3" data-toggle="tab" href="#html-code3" role="tab" aria-controls="html-code3" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap mb-3">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code4" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active mr-1 html-code" id="html-code4" data-toggle="tab" href="#html-code4" role="tab" aria-controls="html-code4" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
			...
			Hello, world! This is a toast message.
                    ...
                    <div class="text-wrap mb-3">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active mr-1 html-code" id="html-code5" data-toggle="tab" href="#html-code5" role="tab" aria-controls="html-code5" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
		...
		Hello, world! This is a toast message.
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code6" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active mr-1 html-code" id="html-code6" data-toggle="tab" href="#html-code6" role="tab" aria-controls="html-code6" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
...
@section('js')
    ...
    <script src="{{ asset('dashboard/plugins/custom-scroll/jquery.mCustomScrollbar.concat.min.js')}}"></script>
    <!-- Internal Input tags js-->
    <script src="{{ asset('dashboard/plugins/inputtags/inputtags.js')}}"></script>
    <!--Internal  Clipboard js-->
    <script src="{{ asset('dashboard/plugins/clipboard/clipboard.min.js')}}"></script>
    <script src="{{ asset('dashboard/plugins/clipboard/clipboard.js')}}"></script>
    <!-- Internal Prism js-->
    <script src="{{ asset('dashboard/plugins/prism/prism.js')}}"></script>
@endsection
