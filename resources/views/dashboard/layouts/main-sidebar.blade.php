        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <a class="side-menu__item gap-10" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label"> {{ __('dashboard/main-sidebar.assistants') }}</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>

                <ul class="slide-menu">
                    <li>
                        <a class="slide-item" href="{{ route('admin.assistants.index') }}">
                            {{ __('dashboard/main-sidebar.assistance') }}
                        </a>
                    </li>
                    <li>
                        <a class="slide-item" href="{{ route('admin.assistants.index') }}">
                            {{ __('dashboard/main-sidebar.packages') }}
                        </a>
                    </li>
                    <li>
                        <a class="slide-item" href="">
                            {{ __('dashboard/main-sidebar.insurance_companies') }}
                        </a>
                    </li>
                    <li>
                        <a class="slide-item" href="">
                            {{ __('dashboard/main-sidebar.first_aid') }}
                        </a>
                    </li>
                    <li>
                        <a class="slide-item" href="">
                            {{ __('dashboard/main-sidebar.ambulance_calls') }}
                        </a>
                    </li>
                </ul>
            </li>
