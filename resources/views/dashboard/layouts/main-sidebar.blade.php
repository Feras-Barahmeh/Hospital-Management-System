...
<aside class="app-sidebar sidebar-scroll">
        <div class="main-sidebar-header active">
                ...
                <a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}"><img
                                src="{{asset('dashboard/img/brand/logo-white.png')}}" class="main-logo dark-theme"
                                alt="logo"></a>
                <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='index') }}"><img
                                src="{{asset('dashboard/img/brand/favicon.png')}}" class="logo-icon" alt="logo"></a>
                <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='index') }}"><img
                                src="{{asset('dashboard/img/brand/favicon-white.png')}}" class="logo-icon dark-theme"
                                alt="logo"></a>
        </div>
        <div class="main-sidemenu">
                        ...
                        <div class="dropdown user-pro-body">
                                <div class="">
                                        <img alt="user-img" class="avatar avatar-xl brround"
                                             src="{{asset('dashboard/img/faces/6.jpg')}}"><span
                ...
                <ul class="side-menu">
                        <li class="side-item side-item-category">{{ __('dashboard/main-sidebar.main') }}</li>
                        <li class="slide">
                                <a class="side-menu__item" href="{{ route('admin.dashboard')}}">
                                        ...
                                        <span class="side-menu__label">{{ __('dashboard/main-sidebar.dashboard') }}</span></a>
                        </li>

                        <li class="side-item side-item-category">{{ __('dashboard/main-sidebar.general') }}</li>
                        ...
                        <li class="slide">
                                ...
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">{{ __('dashboard/main-sidebar.departments') }}</span><i
                                                class="angle fe fe-chevron-down"></i>
                                </a>

                                <ul class="slide-menu">
                                        <li>
                                                <a class="slide-item" href="{{ route('admin.departments.index') }}">
                                                        {{ __('dashboard/main-sidebar.show_all') }}
                                                </a>
                                        </li>
                                </ul>
                        </li>
                        ...
                        <li class="slide">
                                ...
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label"> {{ __('dashboard/main-sidebar.doctors')  }}</span><i
                                                class="angle fe fe-chevron-down"></i>
                                </a>
                        ...
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">{{ __('dashboard/main-sidebar.assistants') }}</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        <li><a class="slide-item"
                                               href="{{ route('admin.assistants.index') }}">{{ __('dashboard/main-sidebar.assistance') }}</a>
                                        </li>
                                        <li><a class="slide-item"
                                               href="{{ route('admin.packages.index')}}">{{ __('dashboard/main-sidebar.packages') }}</a>
                                        </li>
                                        <li><a class="slide-item"
                                               href="{{ route('admin.insurances.index')}}">{{ __('dashboard/main-sidebar.insurance_companies') }}</a>
                                        </li>
                                        <li><a class="slide-item"
                                               href="{{ route('admin.ambulances.index') }}">{{ __('dashboard/main-sidebar.ambulance_calls') }}</a>
                                        </li>
                                </ul>
                        </li>
                        ...
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label">{{ __('dashboard/main-sidebar.patients') }}</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        <li><a class="slide-item"
                                               href="{{ route('admin.patients.index')  }}">{{ __('dashboard/main-sidebar.show_all') }}</a>
                                        </li>
                                        <li><a class="slide-item"
                                               href="{{ route('admin.patients.create') }}">{{ __('dashboard/main-sidebar.add_patient') }}</a>
                                        </li>
                                </ul>
                        </li>
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">{{ __('dashboard/main-sidebar.invoices') }}</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        <li><a class="slide-item" href="{{ route('admin.invoices-assistants.index') }}">{{ __('dashboard/main-sidebar.service_invoices') }}</a></li>
                        ...
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">Mail</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        <li><a class="slide-item" href="{{ url('/' . $page='mail') }}">Mail</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='mail-compose') }}">Mail
                                                        Compose</a></li>
                                        <li><a class="slide-item"
                                               href="{{ url('/' . $page='mail-read') }}">Read-mail</a></li>
                        ...
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">Forms</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        ...
                                        <li><a class="slide-item" href="{{ url('/' . $page='form-advanced') }}">Advanced
                                                        Forms</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='form-layouts') }}">Form
                                                        Layouts</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='form-validation') }}">Form
                                                        Validation</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='form-wizards') }}">Form
                                                        Wizards</a></li>
                        ...
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">Tables</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        <li><a class="slide-item" href="{{ url('/' . $page='table-basic') }}">Basic
                                                        Tables</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='table-data') }}">Data
                                                        Tables</a></li>
                                </ul>
                        </li>
                        <li class="slide">
                        ...
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">Maps</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        <li><a class="slide-item" href="{{ url('/' . $page='map-leaflet') }}">Mapel
                                                        Maps</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='map-vector') }}">Vector
                                                        Maps</a></li>
                                </ul>
                        </li>
                        ...
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">Pages</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        <li><a class="slide-item" href="{{ url('/' . $page='profile') }}">Profile</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='editprofile') }}">Edit-Profile</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='invoice') }}">Invoice</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='pricing') }}">Pricing</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='gallery') }}">Gallery</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='todotask') }}">Todotask</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='faq') }}">Faqs</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='empty') }}">Empty Page</a>
                                        </li>
                                </ul>
                        </li>
                        <li class="slide">
                                ...
                                <ul class="slide-menu">
                                        <li><a class="slide-item"
                                               href="{{ url('/' . $page='background') }}">Background</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='border') }}">Border</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='display') }}">Display</a>
                                        </li>
                                        ...
                                        <li><a class="slide-item" href="{{ url('/' . $page='padding') }}">Padding</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='position') }}">Position</a>
                                        </li>
                        ...
                        <li class="slide">
                                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        ...
                                        <span class="side-menu__label">Custom Pages</span><i
                                                class="angle fe fe-chevron-down"></i></a>
                                <ul class="slide-menu">
                                        <li><a class="slide-item" href="{{ url('/' . $page='signin') }}">Sign In</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='signup') }}">Sign Up</a>
                                        </li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='forgot') }}">Forgot
                                                        Password</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='reset') }}">Reset
                                                        Password</a></li>
                                        <li><a class="slide-item"
                                               href="{{ url('/' . $page='lockscreen') }}">Lockscreen</a></li>
                                ...
                                <ul class="slide-menu">
                                        <li class="sub-slide">
                                                ...
                                                <ul class="sub-slide-menu">
                                                        <li><a class="sub-slide-item" href="{{ url('/' . $page='#') }}">Level01</a>
                                                        </li>
                                                        <li><a class="sub-slide-item" href="{{ url('/' . $page='#') }}">Level02</a>
                                                        </li>
                                                </ul>
                                        </li>
                                </ul>
