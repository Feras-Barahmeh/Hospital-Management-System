...
{{--                    <span class="side-menu__label">Index</span><span class="badge badge-success side-badge">1</span></a>--}}
            ...
            <li class="slide">
                ...
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">{{ __('dashboard/main-sidebar.departments') }}</span><i class="angle fe fe-chevron-down"></i>
                </a>
            ...
            <li class="slide">
                ...
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label"> {{ __('dashboard/main-sidebar.doctors')  }}</span><i class="angle fe fe-chevron-down"></i>
                </a>
