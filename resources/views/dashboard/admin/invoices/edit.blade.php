...
@section('page-header')
        ...
        <div class="breadcrumb-header justify-content-between">
                <div class="my-auto">
                        <div class="d-flex">
                                <h4 class="content-title mb-0 my-auto"> {{ __('dashboard/invoices.title_edit_assistant_invoice') }}</h4>
                        </div>
                </div>
...
@section('content')
        ...
        <!-- row opened -->
                <livewire:edit-assistant-invoices :invoice="$invoice" :assistants="$assistants" :patients="$patients" :doctors="$doctors"/>
        <!-- /row -->
        </div>
        <!-- Container closed -->
        </div>
