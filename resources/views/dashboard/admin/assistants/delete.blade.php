<div class="modal fade" id="delete{{ $assistant->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
            ...
            <form action="{{ route('admin.assistants.destroy', $assistant->id) }}" method="post">
                ...
                <div class="modal-body mt-0">
                    <h5>
                        ...
                        <strong class="text-danger d-inline-block">{{ $assistant->name }}</strong>
                    </h5>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit"
                            class="btn btn-outline-danger pl-lg-4 pr-lg-4 pt-1 pb-1">{{trans('common.delete')}}</button>
                </div>
            </form>
        </div>
    </div>
