...
@section('page-header')
        ...
        <div class="breadcrumb-header justify-content-between">
                <div class="my-auto">
                        <div class="d-flex">
                                <h4 class="content-title mb-0 my-auto"> {{ trans('dashboard/insurances.title_head') }}</h4>
                        </div>
                </div>
                        ...
                        <div class="card mg-b-20">
                                <div class="card-header pb-0">
                                        <div class="d-flex gap-10">
                                                {{-- start add insurance --}}
                                                <button type="button" class="btn btn-primary pl-10 pr-10 pt-1 pb-1 "
                                        ...
                                        <div class="table-responsive">
                                                <table id="example" class="table key-buttons text-md-nowrap" style="width: 100%;">
                                                        ...
                                                        <tr>
                                                                ...
                                                                <th class="wd-15p border-bottom-0"> {{ __('dashboard/insurances.company_code') }}</th>
                                                                <th class="wd-15p border-bottom-0"> {{ __('dashboard/insurances.patient_discount_rate') }}</th>
                                                                <th class="wd-15p border-bottom-0"> {{ __('dashboard/insurances.company_rate') }}</th>
                                                                <th class="wd-15p border-bottom-0"> {{ __('common.name') }}</th>
                                                                <th class="wd-15p border-bottom-0"> {{ __('dashboard/insurances.note') }}</th>
                                                                <th class="wd-15p border-bottom-0"> {{ __('common.status') }}</th>
                                                        ...
                                                        <tbody>
                                                        @each('dashboard.admin.insurances.insurances', $insurances, 'insurance')
                                                        </tbody>
