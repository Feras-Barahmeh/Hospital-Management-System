                                                                ...
                                                                <div class="form-group col-3">
                                                                        ...
                                                                        <select class="form-control select2-no-search"
                                                                                ...
                                                                                <option value="{{ Properties::Owned->value }}"
                                                                                        selected @selected(old('property') === Properties::Owned->value  )>
                                                                                        {{ Properties::Owned->name }}
                                                                                </option>
                                                                                <option value="{{ Properties::Rented->value }}" @selected(old('property') === Properties::Rented->value  )>
