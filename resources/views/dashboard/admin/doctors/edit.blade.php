        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">
                    {{ __('dashboard/doctors.title_head_edit') }}
                </h4>
            </div>
        </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="modal-content h-100">
                            ...
                            <div class="modal-body w-100" id="modal-body-form" style="text-align: center;">
                                ...
                                <div class="live-output" live-img-output>
                                    {!! Blade::img($doctor, 'doctor_default.jpg', class:'img-fluid') !!}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row row-xs formgroup-wrapper mb-2">
                            <div class="col-md-12">
                                <div class="main-form-group">
                                    ...
                                    <input class="form-control" name="name" value="{{ $doctor->name }}" id="name"
                        ...
                        <div class="row row-xs formgroup-wrapper">
                            <div class="col-md-6">
                                <div class="main-form-group">
                                    ...
                                    <input class="form-control" name="email" id="email" value="{{ $doctor->email }}"
                        ...
                        <div class="row row-xs formgroup-wrapper mt-4">
                            <div class="col-md-6">
                                <div class="main-form-group">
                                    ...
                                    <input class="form-control" value="{{ $doctor->phone }}" name="phone"
                                    ...
                                    <select class="form-control select2" name="department_id" id="department">
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{$department->id}}"
                                                @selected($doctor->department->id ==  $department->id)
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                <div class="main-form-group">
                                    ...
                                    <select class="form-control select2" name="status" id="status">
                                        <option value="1" @selected(old('status') == '1') @selected($doctor->status == '1')>
                                            {{ __('dashboard/doctors.enabled') }}
                                        </option>
                                        <option value="0" @selected(old('status') == '0')>
                                            {{ __('dashboard/doctors.not_enabled') }}
                                        </option>
                                    </select>
                                </div>
                            </div>
