...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{ __('dashboard/patients.title_head') }}</h4>
            </div>
        </div>
                        ...
                        {{-- start add patient --}}
                            <a href="{{ route('admin.patients.create') }}"
                                class="btn btn-primary mt-3 mb-0 pl-lg-4 pr-lg-4 pt-1 pb-1">
                                    {{ __('dashboard/patients.add_patient') }}
                            </a>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p border-bottom-0"> {{ __('common.name') }}</th>
                                    <th class="wd-20p border-bottom-0"> {{ __('dashboard/patients.email') }}</th>
                                    <th class="wd-20p border-bottom-0"> {{ __('dashboard/patients.phone_number') }}</th>
                                    <th class="wd-20p border-bottom-0"> {{ __('dashboard/patients.sex') }}</th>
                                    <th class="wd-20p border-bottom-0"> {{ __('dashboard/patients.BOD') }}</th>
                                    <th class="wd-20p border-bottom-0"> {{ __('dashboard/patients.blood_type') }}</th>
                                    <th class="wd-20p border-bottom-0"> {{ __('dashboard/patients.address') }}</th>
                            ...
                            <tbody>
                                @each('dashboard.admin.patients.patients', $patients, 'patient')
                            </tbody>
