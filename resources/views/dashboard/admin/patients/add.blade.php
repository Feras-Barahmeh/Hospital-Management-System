                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group col-3">
                                                                        ...
                                                                        <select class="form-control select2-no-search"
                                                                                id="sex" name="sex">
                                                                                <option value="{{ Sex::Male->value }}" selected @selected(old('sex') === Sex::Male->value )>
                                                                                        {{ Sex::Male->name }}
                                                                                </option>

                                                                                <option value="{{ Sex::Female->value }}"
                                                                                         @selected(old('sex') === Sex::Female->value  )>
                                                                                        {{ Sex::Female->name  }}
                                                                                </option>
                                                                        </select>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                                <div class="form-group col-3">
                                                                        ...
                                                                        <select class="form-control select2-no-search"
                                                                                ...
                                                                                <option value="">{{ __('dashboard/patients.choose') }}</option>
                                                                                @foreach($bloodTypes as $bloodType)
                                                                                        @if($bloodType->type)
                                                                                                <option value="{{ $bloodType->type }}"
                                                                                                        @selected(old('blood_type') === $bloodType->type   )>
                                                                                                        {{ $bloodType->type   }}
                                                                                                </option>
                                                                                        @endif
                                                                                @endforeach
